...
int main() {
    ...
    char subject[10]; //Char ประกาศตัวแปรชื่อวิชา       
    ...
    scanf("%c %d %f", &First_Name,&age, &hight); //รับค่าชื่อ นามสกุล อายุ และส่วนสูง
    ...
    printf("In subject %s, %s got %.2f which is symbolized as '%c'\n",subject,First_Name, grade, gradeA); //แสดงผลวิชา เกรด และสัญลักษณ์เกรด
